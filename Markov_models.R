    ...
    for (i in 1:(duration/timestep)){
      ...
      if (j==1 | j==3){
        ...
        #due to a hand wash event and inactivation on fomites for the fraction of time in which hands were washed, 1 timestep
          ...
          sim.mat[1,i+1]<-sim.mat[1,i]-sim.mat[1,i]*sum(P.1.b.total[2:4])
          sim.mat[2,i+1]<-sim.mat[2,i]-sim.mat[2,i]*sum(P.2.b.total[3:4])
          sim.mat[3,i+1]<-sim.mat[3,i]-sim.mat[3,i]*P.3.b.total[4]
          sim.mat[4,i+1]<-sim.mat[4,i]+sim.mat[1,i]*P.1.b.total[4]+sim.mat[2,i]*P.2.b.total[4]+sim.mat[3,i]*P.3.b.total[4]
          sim.mat[5,i+1]<-sim.mat[5,i]
          ...
          sim.mat[1,i+1]<-sim.mat[1,i]-sim.mat[1,i]*sum(P.1.total[2:4])+sim.mat[3,i]*P.3.total[1]
          sim.mat[2,i+1]<-sim.mat[2,i]-sim.mat[2,i]*sum(P.2.total[1],P.2.total[3:4])+sim.mat[3,i]*P.3.total[2]
          sim.mat[3,i+1]<-sim.mat[3,i]-sim.mat[3,i]*sum(P.3.total[1:2],P.3.total[4:5])+sim.mat[1,i]*P.1.total[3]+sim.mat[2,i]*P.2.total[3]
          sim.mat[4,i+1]<-sim.mat[4,i]+sim.mat[1,i]*P.1.total[4]+sim.mat[2,i]*P.2.total[4]+sim.mat[3,i]*P.3.total[4]
          sim.mat[5,i+1]<-sim.mat[5,i]+sim.mat[3,i]*P.3.total[5]
        }
      }else{
