    ...
    for (i in 2:(duration/timestep)){
      ...
      if (j==1 | j==3){
        ...
        #due to a hand wash event and inactivation on fomites for the fraction of time in which hands were washed, 1 timestep
          ...
          sim.mat[4,i]<-sim.mat[4,i-1]+sim.mat[1,i-1]*P.1.b.total[4]+sim.mat[2,i-1]*P.2.b.total[4]+sim.mat[3,i-1]*P.3.b.total[4]
          ...
          sim.mat[3,i]<-sim.mat[3,i-1]-sim.mat[3,i-1]*sum(P.3.total[1:2],P.3.total[4:5])+sim.mat[1,i-1]*P.1.total[3]+sim.mat[2,i-1]*P.2.total[3]
          sim.mat[4,i]<-sim.mat[4,i-1]+sim.mat[1,i-1]*P.1.total[4]+sim.mat[2,i-1]*P.2.total[4]+sim.mat[3,i-1]*P.3.total[4]
