...
lambdas.1<-c(0,lambda.1.3,lambda.1.4)
...
lambdas.2<-c(lambda.2.3,lambda.2.4)
...
lambdas.3<-c(lambda.3.1,lambda.3.2,lambda.3.4)
...
P.3.total<-c(P.3[1:2],P.3.3,P.3[3])
...
P.4.total<-c(0,0,0,1) #absorbing state
