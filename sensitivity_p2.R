...
source('defining parameters_p2.R')

#run code for the discrete event models------------------------------------------------------------------------------------

source('discrete_event_models_v2.R')
...
write.csv(framecombine,'frame_combine_concexplore.csv')
write.csv(maxdoseplot,'maxdoseplotexplore.csv')
write.csv(paramsave,'paramsaveexplore.csv')
...
length(maxdoseplot$model[maxdoseplot$maxdose==0])/length(maxdoseplot$model[maxdoseplot$model=="discrete"])
